...
export default class StateLIfeCycleLoader extends Component {
    ...
    //loader etle shu...generally Api hoi , api na data fetch thata hoi tya sudhi loader enable rahe ane fetch thai gaya pachi te disable thai jai. Apdi pase atyre api nathi etle button na click event upar apde perform kari rahiya chaiye.

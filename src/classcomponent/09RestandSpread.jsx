...
export default class RestandSpread extends Component {
  render() {
    return (
      <>
       <>
                ...
                <p>when (...Para) is passed in parameter then it is called spread operator and (....Arg) passed in argument then called as rest operator.</p>
